...
import { Package, Plus, CheckCircle2, AlertCircle, ShoppingBag, Clock, ChevronRight, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-primary text-white text-[11px] font-bold rounded-lg hover:bg-primary/90 transition-all flex items-center gap-1.5 shadow-sm uppercase tracking-wider"
        >
          <Plus size={13} />
          Asignar Paquete
        </button>
